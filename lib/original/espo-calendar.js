define("modules/crm/views/calendar/calendar", ["exports", "view", "moment", "fullcalendar"], function (_exports, _view, _moment, FullCalendar) {
  "use strict";
  ...
  class CalendarView extends _view.default {
    ...
    setup() {
      ...
      this.slotDuration = this.options.slotDuration || this.getMetadata().get('clientDefs.Calendar.slotDuration') || this.slotDuration;
      this.colors = {
        ...this.colors,
    ...
    isToday() {
      ...
      const endUnix = (0, _moment.default)(view.activeStart).unix();
    ...
    getTitle() {
      ...
      if (viewName === 'week') {
        ...
        title = (0, _moment.default)(view.currentStart).format(format);
      }
    ...
    handleAllDay(event, notInitial) {
      ...
      if (!start || !end) {
        ...
        if (start.format('d') !== end.format('d') && (end.hours() !== 0 || end.minutes() !== 0) && end.unix() - start.unix() >= 86400) {
          event.allDay = true;
