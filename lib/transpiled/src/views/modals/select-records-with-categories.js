define("views/modals/select-records-with-categories", ["exports", "views/modals/select-records", "views/list-with-categories"], function (_exports, _selectRecords, _listWithCategories) {
  "use strict";
  ...
  class SelectRecordsWithCategoriesModalView extends _selectRecords.default {
    ...
    applyCategoryToCollection() {
      _listWithCategories.default.prototype.applyCategoryToCollection.call(this);
    }

    // noinspection JSUnusedGlobalSymbols
    isCategoryMultiple() {
      _listWithCategories.default.prototype.isCategoryMultiple.call(this);
    }
  }

  // noinspection JSUnusedGlobalSymbols
  var _default = SelectRecordsWithCategoriesModalView;
  _exports.default = _default;
});
//# sourceMappingURL=select-records-with-categories.js.map ;