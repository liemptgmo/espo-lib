define("views/modals/select-records", ["exports", "views/modal", "search-manager"], function (_exports, _modal, _searchManager) {
  "use strict";
  ...
  class SelectRecordsModalView extends _modal.default {
    ...
    setupSearch() {
      const searchManager = this.searchManager = new _searchManager.default(this.collection, 'listSelect', null, this.getDateTime());
  ...
  var _default = SelectRecordsModalView;
  _exports.default = _default;
});
//# sourceMappingURL=select-records.js.map ;