define("views/list-related", ["exports", "views/main", "search-manager"], function (_exports, _main, _searchManager) {
  "use strict";
  ...
  class ListRelatedView extends _main.default {
    ...
    setupSearchManager() {
      ...
      const searchManager = new _searchManager.default(collection, 'list', null, this.getDateTime(), null);
    ...
    actionQuickCreate() {
      ...
      let attributes = {};
      const attributeMap = this.getMetadata().get(['clientDefs', this.scope, 'relationshipPanels', link, 'createAttributeMap']) || {};
      ...
      new Promise(resolve => {
        ...
        const viewName = this.getMetadata().get(['clientDefs', foreignScope, 'modalViews', 'edit']) || 'views/modals/edit';
    ...
    getHeader() {
      ...
      const $name = $('<a>').attr('href', recordUrl).addClass('font-size-flexible title').text(name);
      ...
      return this.buildHeaderHtml([$root, $name, $link]);
    }
  ...
  var _default = ListRelatedView;
  _exports.default = _default;
});
//# sourceMappingURL=list-related.js.map ;