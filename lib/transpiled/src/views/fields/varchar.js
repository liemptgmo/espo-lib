define("views/fields/varchar", ["exports", "views/fields/base", "helpers/reg-exp-pattern"], function (_exports, _base, _regExpPattern) {
  "use strict";
      ...
      if ((this.isEditMode() || this.isSearchMode()) && (this.params.options && this.params.options.length || this.useAutocompleteUrl)) {
        ...
        if (this.useAutocompleteUrl) {
          ...
          autocompleteOptions.lookup = (query, done) => {
            Espo.Ajax.getRequest(this.getAutocompleteUrl(query)).then(response => {
