define("views/fields/currency", ["exports", "views/fields/float", "ui/select"], function (_exports, _float, _select) {
  ...
  class CurrencyFieldView extends _float.default {
    ...
    /** @inheritDoc */
    data() {
      let currencyValue = this.model.get(this.currencyFieldName) || this.getPreferences().get('defaultCurrency') || this.getConfig().get('defaultCurrency');
    ...
    setup() {
      ...
      let currencyValue = this.currencyValue = this.model.get(this.currencyFieldName) || this.defaultCurrency;
  ...
  var _default = CurrencyFieldView;
