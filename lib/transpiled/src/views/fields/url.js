define("views/fields/url", ["exports", "views/fields/varchar"], function (_exports, _varchar) {
  ...
  class UrlFieldView extends _varchar.default {
    ...
    validateValid() {
      ...
      const msg = this.translate('fieldInvalid', 'messages').replace('{field}', this.translate(this.name, 'fields', this.entityType));
    ...
    validateMaxLength() {
      ...
      const msg = this.translate('fieldUrlExceedsMaxLength', 'messages').replace('{maxLength}', maxLength).replace('{field}', this.translate(this.name, 'fields', this.entityType));
      this.showValidationMessage(msg);
      return true;
    }
    fetch() {
