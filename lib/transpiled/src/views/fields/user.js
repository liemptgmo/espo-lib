define("views/fields/user", ["exports", "views/fields/link"], function (_exports, _link) {
  "use strict";
  ...
  class UserFieldView extends _link.default {
    ...
    setupSearch() {
      ...
      this.addActionHandler('selectLinkTeams', () => {
        Espo.Ui.notify(' ... ');
        let viewName = this.getMetadata().get('clientDefs.Team.modalViews.select') || 'views/modals/select-records';
