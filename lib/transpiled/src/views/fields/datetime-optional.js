define("views/fields/datetime-optional", ["exports", "views/fields/datetime", "moment"], function (_exports, _datetime, _moment) {
  ...
  class DatetimeOptionalFieldView extends _datetime.default {
    ...
    validateAfter() {
      ...
      let isNotValid = this.validateAfterAllowSameDay && this.model.get(this.nameDate) ? (0, _moment.default)(value).unix() < (0, _moment.default)(otherValue).unix() : (0, _moment.default)(value).unix() <= (0, _moment.default)(otherValue).unix();
      if (isNotValid) {
  ...
  var _default = DatetimeOptionalFieldView;
  _exports.default = _default;
});
//# sourceMappingURL=datetime-optional.js.map ;