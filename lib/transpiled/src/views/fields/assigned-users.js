define("views/fields/assigned-users", ["exports", "views/fields/link-multiple"], function (_exports, _linkMultiple) {
  ...
  class AssignedUsersFieldView extends _linkMultiple.default {
    ...
    getDetailLinkHtml(id, name) {
      ...
      let avatarHtml = this.isDetailMode() ? this.getHelper().getAvatarHtml(id, 'small', 14, 'avatar-link') : '';
      if (!avatarHtml) {
        return html;
      }
  ...
  var _default = AssignedUsersFieldView;
  _exports.default = _default;
});
//# sourceMappingURL=assigned-users.js.map ;