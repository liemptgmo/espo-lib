define("views/fields/link-parent", ["exports", "views/fields/base", "helpers/record-modal", "ui/select"], function (_exports, _base, _recordModal, _select) {
  "use strict";
  ...
  class LinkParentFieldView extends _base.default {
    ...
    quickView() {
      ...
      let helper = new _recordModal.default(this.getMetadata(), this.getAcl());
  ...
  var _default = LinkParentFieldView;
  _exports.default = _default;
});
//# sourceMappingURL=link-parent.js.map ;