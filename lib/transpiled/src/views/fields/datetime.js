define("views/fields/datetime", ["exports", "views/fields/date", "moment"], function (_exports, _date, _moment) {
  ...
  class DatetimeFieldView extends _date.default {
    ...
    setDefaultTime() {
      let dtString = (0, _moment.default)('2014-01-01 00:00').format(this.getDateTime().getDateTimeFormat()) || '';
    ...
    splitDatetime(value) {
      let m = (0, _moment.default)(value, this.getDateTime().getDateTimeFormat());
    ...
    validateDatetime() {
      if (this.model.get(this.name) === -1) {
        let msg = this.translate('fieldShouldBeDatetime', 'messages').replace('{field}', this.getLabelText());
  ...
  var _default = DatetimeFieldView;
