define("views/fields/complex-created", ["exports", "views/fields/base"], function (_exports, _base) {
  ...
  class ComplexCreatedFieldView extends _base.default {
    // language=Handlebars
    detailTemplateContent = `<span data-name="{{baseName}}At" class="field">{{{atField}}}</span>
    ...
    createField(part) {
      ...
      let viewName = this.model.getFieldParam(field, 'view') || this.getFieldManager().getViewName(type);
  ...
  var _default = ComplexCreatedFieldView;
  _exports.default = _default;
});
//# sourceMappingURL=complex-created.js.map ;