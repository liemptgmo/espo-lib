define("views/fields/link-multiple", ["exports", "views/fields/base", "helpers/record-modal"], function (_exports, _base, _recordModal) {
  "use strict";
  ...
  class LinkMultipleFieldView extends _base.default {
      ...
      if (this.isEditMode() || this.isSearchMode()) {
        ...
        if (!this.autocompleteDisabled) {
          ...
          this.$element.autocomplete({
            lookup: (q, callback) => {
              Promise.resolve(this.getAutocompleteUrl(q)).then(url => {
    ...
    actionSelect() {
      ...
      const mandatorySelectAttributeList = this.mandatorySelectAttributeList || panelDefs.selectMandatoryAttributeList;
      const createButton = this.isEditMode() && (!this.createDisabled && !panelDefs.createDisabled || this.forceCreateButton);
  ...
  var _default = LinkMultipleFieldView;
  _exports.default = _default;
});
//# sourceMappingURL=link-multiple.js.map ;