define("views/fields/wysiwyg", ["exports", "views/fields/text", "helpers/misc/summernote-custom"], function (_exports, _text, _summernoteCustom) {
  ...
  class WysiwygFieldView extends _text.default {
    ...
    setupToolbar() {
      this.buttons = {};
      this.toolbar = this.params.toolbar || this.toolbar || [['style', ['style']], ['style', ['bold', 'italic', 'underline', 'clear']], ['fontsize', ['fontsize']], ['color', ['color']], ['para', ['ul', 'ol', 'paragraph']], ['height', ['height']], ['table', ['espoTable', 'espoLink', 'espoImage', 'hr']], ['misc', ['codeview', 'fullscreen']]];
    ...
    renderDetail() {
      ...
      const addFallbackClass = this.getThemeManager().getParam('isDark') && (this.htmlHasColors(body) || this.noStylesheet);
