define("views/global-search/global-search", ["exports", "view"], function (_exports, _view) {
  "use strict";
  ...
  class GlobalSearchView extends _view.default {
    ...
    showPanel() {
      ...
      $document.on('click.global-search', e => {
        if (e.target.tagName === 'A' && $(e.target).data('action') !== 'showMore' && !$(e.target).hasClass('global-search-button')) {
