define("views/record/search", ["exports", "view", "helpers/misc/stored-text-search"], function (_exports, _view, _storedTextSearch) {
  "use strict";
  ...
  class SearchView extends _view.default {
    ...
    initTextSearchAutocomplete() {
      ...
      const options = {
        ...
        lookup: (text, done) => {
          const suggestions = this.storedTextSearchHelper.match(text, this.autocompleteLimit).map(item => {
            return {
              value: item
            };
          });
