define("views/record/list-tree", ["exports", "views/record/list"], function (_exports, _list) {
  "use strict";
  ...
  class ListTreeRecordView extends _list.default {
    ...
    getItemEl(model, item) {
      return this.getSelector() + ' li[data-id="' + model.id + '"] span.cell[data-name="' + item.name + '"]';
    }
    getCreateAttributes() {
      return {};
    }
  ...
  var _default = ListTreeRecordView;
