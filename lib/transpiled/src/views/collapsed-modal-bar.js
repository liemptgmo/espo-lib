define("views/collapsed-modal-bar", ["exports", "view"], function (_exports, _view) {
  "use strict";
  ...
  class CollapsedModalBar extends _view.default {
    ...
    init() {
      this.on('render', () => {
        if ($('.collapsed-modal-bar').length === 0) {
          $('<div />').addClass('collapsed-modal-bar').appendTo('body');
        }
      });
    }
    setup() {
  ...
  var _default = CollapsedModalBar;
  _exports.default = _default;
});
//# sourceMappingURL=collapsed-modal-bar.js.map ;