define("views/dashlets/abstract/record-list", ["exports", "views/dashlets/abstract/base", "search-manager"], function (_exports, _base, _searchManager) {
  "use strict";
  ...
  class RecordListDashletView extends _base.default {
    ...
    afterRender() {
      this.getCollectionFactory().create(this.scope, collection => {
        ...
        this.searchManager = new _searchManager.default(collection, 'list', null, this.getDateTime(), searchData);
        if (!this.scope) {
  ...
  var _default = RecordListDashletView;
