define("views/stream/notes/email-received", ["exports", "views/stream/note"], function (_exports, _note) {
  "use strict";
  ...
  class EmailReceivedNoteStreamView extends _note.default {
    ...
    setup() {
      ...
      if (data.personEntityId) {
        ...
        this.messageData['from'] = $('<a>').attr('href', '#' + data.personEntityType + '/view/' + data.personEntityId).text(data.personEntityName);
      }
  ...
  var _default = EmailReceivedNoteStreamView;
