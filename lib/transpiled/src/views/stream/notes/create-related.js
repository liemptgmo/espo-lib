define("views/stream/notes/create-related", ["exports", "views/stream/note"], function (_exports, _note) {
  ...
  class CreateRelatedNoteStreamView extends _note.default {
    ...
    setup() {
      ...
      this.messageData['relatedEntity'] = $('<a>').attr('href', '#' + this.entityType + '/view/' + this.entityId).text(this.entityName);
      this.createMessage();
    }
  }
  var _default = CreateRelatedNoteStreamView;
  _exports.default = _default;
});
//# sourceMappingURL=create-related.js.map ;