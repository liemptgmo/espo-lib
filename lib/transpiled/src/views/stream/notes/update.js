define("views/stream/notes/update", ["exports", "views/stream/note"], function (_exports, _note) {
    ...
    setup() {
      ...
      this.getModelFactory().create(this.model.get('parentType'), model => {
        ...
        fields.forEach(field => {
          ...
          let viewName = this.getMetadata().get(['entityDefs', model.entityType, 'fields', field, 'view']) || this.getFieldManager().getViewName(type);
  ...
  var _default = UpdateNoteStreamView;
