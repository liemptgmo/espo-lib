define("helpers/misc/summernote-custom", ["exports", "jquery"], function (_exports, _jquery) {
  "use strict";
          ...
          return ui.buttonGroup([ui.button({
            ...
            callback: $node => {
              ...
              const createTable = (colCount, rowCount, options) => {
                ...
                trHTML = trs.join('');
                const $table = (0, _jquery.default)('<table>' + trHTML + '</table>');
...
//# sourceMappingURL=summernote-custom.js.map ;